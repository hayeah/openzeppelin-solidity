...
contract('ECDSA', function ([_, other]) {
  ...
  context('recover with valid signature', function () {
    context('with v0 signature', function () {
      ...
      const signatureWithoutVersion =
        '2e817a350cc331dc5f42198c6e1344ac3e7226c7369d06f14339d99b31fbe50d3590fe35ddf2d15753771d21fb4c436295309bb3e1b4dcec59e9a15136fa698d';

      context('with 00 as version value', function () {
        it('returns 0', async function () {
          const version = '00';
          const signature = version + signatureWithoutVersion;
  ...
  //         (await this.ecdsa.recover(toEthSignedMessageHash(TEST_MESSAGE), signature)).should.equal(other);
  //       });
  //     });
